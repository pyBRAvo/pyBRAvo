 ...
 *** Summary:
 * 
 * * CLI - after initial step
 * upstreamRegulatoryConstructQuery
 * upstreamSignalingConstructQuery
 * 
 * * Web & CLI - initial step
 * initialUpRegulatoryQuery
 * initialDownRegulatoryQuery
 * initialSignalingQuery
 * IdToNameQuery
 * 
 * * Optimized queries :
 * upstreamRegulatoryConstructQueryOptimized
 * exploreController
 *
 */
public class SparqlQuery {
     ...
     * @return
     */
    public static Model RegulatoryConstruct(Model listModel, Model tempModel, List genesDone, String direction, Boolean smolecule, List<String> dataSources, int maxDepth, int currentDepth) {
